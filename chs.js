...
var cnItems = {
    ...
    "¼ the speed": "¼ 的速度",
    "A Beggar eats food at 0.2 units per second so in the first screenshot it will eat that food card at 0.2 units per second. In the second since it's surrounded by 4 food cards each will be drained at": "乞丐以每秒 0.2 个单位的速度吃食物，因此在第一个屏幕截图中，它会以每秒 0.2 个单位的速度吃掉那张食物卡。在第二个中，因为它被 4 张食物卡包围，每张食物卡将在",
    ...
    "Forager": "觅食者",
    "Generates Meat Haunch cards  every 5 seconds while consuming food.": "食用食物时每 5 秒生成一次肉腿卡。",
    "Peasant": "农夫",
    "Pig Pen": "猪圈",
